...
-- 5) Restaurants -------------------------------------------
-- Anyone may READ (the public scanned menu needs this + slug checks).
create policy p_rest_read on restaurants for select using (true);
-- Only a signed-in owner may create / edit / delete their OWN restaurant.
...
-- 8) Orders ------------------------------------------------
-- Customers (anon) may place an order. Only the owner may read/advance/settle.
